          ...
          blocks: [
            ...
            },
            {
              ...
              steps: [
                ...
                "Discuss LMQ as the standard — everything in Club Coach traces back to it. Your role is to help each instructor align with that standard.",
                "Share honestly: which of the 5 Key Elements do you feel least confident assessing right now?",
              ],
            ...
            },
            {
              ...
              steps: [
                "Dreyfus (5 min): Open the Dreyfus Model tool and walk through the five stages. Think of an instructor you know — where are they for Choreography vs Connection? Same stage?",
                "ETAs (5 min): Open the ETAs tool and walk through the trust levels and the 8 activities. Discuss: what would you need to see before you'd trust someone to teach completely unsupervised?",
                "SSDL (5 min): Open the SSDL tool and walk through the four coaching roles. Reflect on a time you coached someone with the wrong approach for their stage — what happened?",
                "Implementation Intentions (5 min): Walk through the if-then format and open the Intention Builder. Compare: what's the difference between \"work on your connection\" and a specific if-then plan?",
                "E-P-E (5 min): Walk through Elicit–Provide–Elicit and open Conversation Templates. Consider: what happens when you lead with your observation instead of asking first?",
              ],
